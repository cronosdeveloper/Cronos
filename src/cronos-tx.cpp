...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cronos Core cronos-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cronos-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cronos transaction") + "\n" +
                               "  cronos-tx [options] -create [commands]   " + _("Create hex-encoded cronos transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded crsx transaction
