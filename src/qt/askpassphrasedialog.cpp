                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zCRS || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending CRS because you wouldn't check it anyway.
    if (context == Context::Send_CRS || context == Context::Send_zCRS) {
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("Cronos will close now to finish the encryption process. "
                               ...
                               "your CRSs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
