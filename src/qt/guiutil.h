...
/** Utility functions used by the Cronos Qt UI.
 */
namespace GUIUtil
{
...
// Render crsx addresses in monospace font
...
// Parse "crsx:" URI into recipient object, return true on successful parsing
