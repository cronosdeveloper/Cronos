...
/* Cronos GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Cronos"
#define QAPP_ORG_DOMAIN "cronoscoin.com"
#define QAPP_APP_NAME_DEFAULT "cronos-Qt"
#define QAPP_APP_NAME_TESTNET "cronos-Qt-testnet"
