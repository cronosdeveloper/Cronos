...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a Cronos initiative\n"
            "  vote-alias         - Vote on a Cronos initiative\n"
            "  vote               - Vote on a Cronos initiative/budget\n"
...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 6)
        throw runtime_error(
            "preparebudget \"proposal-name\" \"url\" payment-count block-start \"crsx-address\" monthy-payment\n"
            ...
            "5. \"crsx-address\":   (string, required) CRSX address to send payments to\n"
