...
This means one can have an always-on cronosd instance running, and another local cronosd/cronos-qt instance which connects to this node and receives blocks from it.
