...
RESOURCES += src/qt/cronos.qrc src/qt/cronos_locale.qrc

TRANSLATIONS += src/qt/locale/cronos_bg.ts \
                src/qt/locale/cronos_de.ts \
                src/qt/locale/cronos_en.ts \
                src/qt/locale/cronos_es.ts \
                src/qt/locale/cronos_fi.ts \
                src/qt/locale/cronos_fr.ts \
                src/qt/locale/cronos_it.ts \
                src/qt/locale/cronos_ja.ts \
                src/qt/locale/cronos_pl.ts \
                src/qt/locale/cronos_pt.ts \
                src/qt/locale/cronos_ru.ts \
                src/qt/locale/cronos_sk.ts \
                src/qt/locale/cronos_sv.ts \
                src/qt/locale/cronos_vi.ts \
                src/qt/locale/cronos_zh_CN.ts \
                src/qt/locale/cronos_zh_TW.ts
